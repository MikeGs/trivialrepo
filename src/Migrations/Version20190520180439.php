 ...
 */
final class Version20190520180439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dificultat (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pregunta (id INT AUTO_INCREMENT NOT NULL, id_dificultat_id INT DEFAULT NULL, id_tema_id INT DEFAULT NULL, tipus_id INT NOT NULL, pregunta_cat LONGTEXT NOT NULL, pregunta_es LONGTEXT DEFAULT NULL, pregunta_en LONGTEXT DEFAULT NULL, resposta_correcta_cat LONGTEXT DEFAULT NULL, resposta_correcta_es LONGTEXT DEFAULT NULL, resposta_correcta_en LONGTEXT DEFAULT NULL, resposta_incorrecta1cat LONGTEXT DEFAULT NULL, resposta_incorrecta1es LONGTEXT DEFAULT NULL, resposta_incorrecta1en LONGTEXT DEFAULT NULL, resposta_incorrecta2cat LONGTEXT DEFAULT NULL, resposta_incorrecta2es LONGTEXT DEFAULT NULL, resposta_incorrecta2en LONGTEXT DEFAULT NULL, resposta_incorrecta3cat LONGTEXT DEFAULT NULL, resposta_incorrecta3es LONGTEXT DEFAULT NULL, resposta_incorrecta3en LONGTEXT DEFAULT NULL, activa TINYINT(1) NOT NULL, INDEX IDX_AEE0E1F7DB8A3CB0 (id_dificultat_id), INDEX IDX_AEE0E1F778D72367 (id_tema_id), INDEX IDX_AEE0E1F7898C381B (tipus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuari (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', codi_alumne VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, cognoms VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_68CC94FF92FC23A8 (username_canonical), UNIQUE INDEX UNIQ_68CC94FFA0D96FBF (email_canonical), UNIQUE INDEX UNIQ_68CC94FFC05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE grup (id INT AUTO_INCREMENT NOT NULL, id_nivell_id INT NOT NULL, nom VARCHAR(255) NOT NULL, codi VARCHAR(255) NOT NULL, datainici DATETIME NOT NULL, datafinal DATETIME NOT NULL, finalitzat TINYINT(1) NOT NULL, tempsresposta DOUBLE PRECISION NOT NULL, id_administrador INT NOT NULL, puntuacio_facil DOUBLE PRECISION NOT NULL, puntuacio_dificil DOUBLE PRECISION NOT NULL, INDEX IDX_D28D50175E8AFC02 (id_nivell_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
