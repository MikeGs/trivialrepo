 ...
 */
final class Version20190328185628 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pregunta (id INT AUTO_INCREMENT NOT NULL, id_grup_id INT DEFAULT NULL, id_dificultat_id INT DEFAULT NULL, id_tema_id INT DEFAULT NULL, text LONGTEXT NOT NULL, resposta_correcta LONGTEXT NOT NULL, resposta_incorrecta1 LONGTEXT NOT NULL, resposta_incorrecta2 LONGTEXT NOT NULL, resposta_incorrecta3 LONGTEXT NOT NULL, activa TINYINT(1) NOT NULL, INDEX IDX_AEE0E1F788077BAE (id_grup_id), INDEX IDX_AEE0E1F7DB8A3CB0 (id_dificultat_id), INDEX IDX_AEE0E1F778D72367 (id_tema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuari (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', codi_alumne VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, cognoms VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_68CC94FF92FC23A8 (username_canonical), UNIQUE INDEX UNIQ_68CC94FFA0D96FBF (email_canonical), UNIQUE INDEX UNIQ_68CC94FFC05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
